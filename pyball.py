...
class RenderedSoup():
    ...
    def find_bonds(self):
        ...
        self.draw_to_screen_atoms = [a for a in self.draw_to_screen_atoms if
                                     a.type not in backbone_atoms and a.element != "H"]
...
class Camera():
    ...
    def rotate(self, phi_diff, theta_diff, psi_diff):
        rotate(angle=phi_diff, axis=(0, 1, 0))
        rotate(angle=theta_diff, axis=(1, 0, 0))
        rotate(angle=psi_diff, axis=(0, 0, -1))
        self.recalc_model()
